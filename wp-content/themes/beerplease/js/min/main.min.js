...
!function(e){"use strict";e.Common=function(){this.elements={body:e("body")},this.pageFunction={pageHome:"home"},this.windowWidth=screen.width,this.device={desktop:this.windowWidth>=1024?!0:!1,tablet:this.windowWidth>=768&&this.windowWidth<1024?!0:!1,smartphone:this.windowWidth<768?!0:!1},this.init()},e.Common.prototype={init:function(){var i=this;i.pageAll(),e.each(i.pageFunction,function(e,t){i.elements.body.hasClass(t)&&"function"==typeof i[e]&&i[e]()})},pageAll:function(){e.extend(this.elements,{biggerLink:e(".is-link"),cookieLegal:e(".notice-cookie")}),this.biggerLink(),this.noticeCookie()},biggerLink:function(){this.elements.biggerLink.click(function(i){i.preventDefault(),location.href=e(this).find("a:first").attr("href")})},noticeCookie:function(){var i=this;this.elements.cookieLegal.length&&i.elements.cookieLegal.find("button").click(function(){var t=new Date,o=t.getTime();t.setFullYear(t.getFullYear()+1),e(this).setCookie("BEERPLEASE-COOKIE-ACCEPT",o,t,cookiePathApp,cookieDomainApp),i.elements.cookieLegal.fadeOut()})},pageHome:function(){e.extend(this.elements,{headerImage:e(".header-image")});var i=this;this.device.smartphone||(i.headerParallax(),e(window).scroll(function(){i.headerParallax()}))},headerParallax:function(){var i=this,t=e(window).scrollTop();i.elements.headerImage.css({"background-position":"center -"+t/4+"px"})}},e.fn.getCookie=function(i){var t=document.cookie.split("; "),o=void 0;return e(t).each(function(e,t){-1!=t.indexOf(i)&&(o=t.split("=")[1])}),o},e.fn.setCookie=function(e,i,t,o,n,a){document.cookie=e+" = "+i+"  "+(void 0===t?"":"; expires = "+t.toGMTString())+(void 0===o?"":"; path = "+o)+(void 0===n?"":"; domain = "+n)+(a===!0?"; secure":"")},e(document).ready(function(){new e.Common})}(jQuery);